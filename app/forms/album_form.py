...
class AlbumForm(FlaskForm):
    ...
    description = StringField("Description", validators=[DataRequired(message="Description is required"), Length(min=5, max=30, message="Description must be 10-200 characters.")])
